...
public class ImageService {
	...
	public List<Image> showLikeImage(String username){
		return imageRepo.showLikeImage(username);
	}
	...
	public long countLikeImage(String username) {
		return imageRepo.countLikeImage(username);
	}
